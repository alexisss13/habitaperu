        ...
        <div style={{
          ...
          <div style={{ marginBottom: '32px' }}>
            <h2 style={{
              ...
              marginBottom: '8px',
              lineHeight: '1.3'
            }}>Te damos la bienvenida a Habita Perú</h2>
          </div>
